...
<details>
  ...
  <ul>
    <li>게임 매니징</li>
    <li>전체적인 게임 로직 구성</li>
    <li>던전 방 랜덤 생성 & 진행 구현</li>
    <li>적, 아이템, 장애물 통합 작업</li>
    <li>오디오 시스템 & 사운드 리소스 추가</li>
    <li>코드 리팩토링 및 버그 수정</li>
  </ul>
</details>
</br>
...
<details>
  <summary>구현 목록</summary>
  <ul>
    <li>장애물 & 함정 구현 [장애물, 근거리 함정, 원거리 함정, 스폰 함정]</li>
    <li>함정 방 레벨 디자인</li>
    <li>로비 UI 구현</li>
    <li>인게임 Pause, GameOver 구현</li>
    <li>장애물 버그 수정 및 개선</li>
    <li>UI 리소스 추가</li>
  </ul>
</details>
</br>
...
<details>
  <summary>구현 목록</summary>
  <ul>
    <li>적 구현 [움직임, 공격, 애니메이션]</li>
    <li>NevMesh를 활용한 적 AI 움직임 구현</li>
    <li>보스 구현 [패턴 & 보스 UI 체력바, 애니메이션]</li>
    <li>보스 인트로 구현</li>
    <li>일반 방, 보스 방 레벨 디자인</li>
    <li>기타 UI & Audio 리소스 추가</li>
  </ul>
</details>
</br>
...
<details>
  <summary>구현 목록</summary>
  <ul>
    <li>ScriptableObject 아이템 데이터 구현 [픽업, 패시브]</li>
    <li>아이템을 활용한 오브젝트 구현 [상자, 상점 & 보물방 아이템 전시]</li>
    <li>아이템 기능 구현 [체력, 폭탄, 열쇠, 코인, 패시브 아이템]</li>
    <li>일반 방 레벨 디자인</li>
    <li>기타 버그 수정</li>
  </ul>
</details>
...
<details>
  <summary>구현 목록</summary>
  <ul>
    <li>플레이어 구현 [InputSystem, 애니메이션, 디자인]</li>
    <li>플레이어 디테일 작업 [피격 이펙트, 넉백]</li>
    <li>이동 조작과 공격 조작에 다른 애니메이션 구현</li>
    <li>스킬 구현 [폭탄]</li>
    <li>오브젝트 풀링 구현</li>
  </ul>
</details>
